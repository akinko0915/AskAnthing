...
$comments['input_pre_reader_name'] = '';
$comments['input_pre_comment'] = '';
...
if (isset($_SESSION['input_error_reader_name'])) {
    $comments['input_error_reader_name'] = $_SESSION["input_error_reader_name"];
    unset($_SESSION["input_error_reader_name"]);
}

if (isset($_SESSION['input_error_comment'])) {
    $comments['input_error_comment'] = $_SESSION["input_error_comment"];
    unset($_SESSION["input_error_comment"]);
}

if (isset($_SESSION['input_pre_reader_name'])) {
    $comments['input_pre_reader_name'] = $_SESSION["input_pre_reader_name"];
    unset($_SESSION["input_pre_reader_name"]);
}

if (isset($_SESSION['input_pre_comment'])) {
    $comments['input_pre_comment'] = $_SESSION["input_pre_comment"];
    unset($_SESSION["input_pre_comment"]);
}